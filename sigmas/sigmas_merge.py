...
class aligned_scheduler:
    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                # "scheduler": (ldm_patched.modules.samplers.SCHEDULER_NAMES, {"default":"simple"}),
    ...
    def simple_output(self, model, steps, model_type, force_sigma_min):
        ...
        sigmas  = ldm_patched.modules.samplers.calculate_sigmas(model.get_model_object("model_sampling"), "simple", 1000)[indices]
